---
title: "Thesis Awards"
description: "Yearly awards for the best PhD and MSc theses in software engineering."
---

import Callout from '~/components/Callout.astro';

<Callout>
**Nominate a thesis:** see the [call for submissions](/awards/call/) for the current deadline and form. Past winners are listed on the [winners page](/awards/winners/).
</Callout>
...
For the important dates, submission procedure, and status of the current edition, please see the [call for submissions](/awards/call/).

For past editions, please see the [history of the awards](/awards/winners/).
