...
description: "Worked towards a national platform for Master thesis projects in software research."
group: true
archived: true
order: 11
members:
  - { name: "Marieke Huisman", role: "chair", org: "University of Twente" }
  - { name: "Ana Oprescu", org: "University of Amsterdam, Vrije Universiteit Amsterdam" }
---
...
If you would like to collaborate with members of VERSEN in the form of a master thesis project, see our [call for participation](/resources/msc-thesis-collaborations/) on master thesis collaboration between companies and universities.
