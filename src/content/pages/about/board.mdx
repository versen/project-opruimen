---
title: "Board"
description: "The executive board runs VERSEN day to day; the full board brings together software engineering professors from across the country."
---

import People from '~/components/People.astro';

import { executive, support } from '~/data/board';

## Executive board

<People people={executive} />

<p class="muted">* Terms run from SEN Symposium to SEN Symposium.</p>
...
*   [Willem Jan "Wan" Fokkink](https://www.cs.vu.nl/~wanf), **Vrije Universiteit Amsterdam**
